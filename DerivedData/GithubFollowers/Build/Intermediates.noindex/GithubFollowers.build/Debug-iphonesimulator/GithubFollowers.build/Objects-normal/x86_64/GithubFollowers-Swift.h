...
#ifndef GITHUBFOLLOWERS_SWIFT_H
#define GITHUBFOLLOWERS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GithubFollowers",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15GithubFollowers11AppDelegate")
...
SWIFT_CLASS("_TtC15GithubFollowers12FollowerCell")
...
SWIFT_CLASS("_TtC15GithubFollowers26FollowerListViewController")
...
SWIFT_CLASS("_TtC15GithubFollowers22GithubTabBarController")
@interface GithubTabBarController : UITabBarController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC15GithubFollowers13SceneDelegate")
...
SWIFT_CLASS("_TtC15GithubFollowers20SearchViewController")
...
@interface SearchViewController (SWIFT_EXTENSION(GithubFollowers)) <UITextFieldDelegate>
